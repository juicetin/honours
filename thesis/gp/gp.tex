...
\todo{(expand section)}
To train our data, we chose the extreme case of of cross-validation for model selection, where the number of folds used, $k$, is equal to the number of datapoints.
