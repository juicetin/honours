...
As the $24$-label case has over $400$ weights, with a little over half converging, the $456$ separate distributions have not been included here, but can be found in the appendix \todo{(not included yet. not sure if worth including in appendix though actually)}.
