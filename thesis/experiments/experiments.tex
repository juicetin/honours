...
\todo{(insert (more?) results of the illustrative example here)}

\begin{tabular}{|c|c|}
    \hline
    Algorithm & Root mean squared error \\\hline
    Dirichlet Multinomial Regressor & 0.0741 \\
    Gaussian Process Classifier (argmax) & 0.2667 \\
    \hline
\end{tabular}
