...
% \hfill September 17, 2014
    ...
    \includegraphics[scale=0.37,left]{gaussian.jpg}
    ...
    \includegraphics[scale=0.37,left]{gp-inference.jpg}
    ...
    \includegraphics[left,scale=0.38]{logit.jpg}
    ...
    \includegraphics[scale=0.5]{inducing_inputs.jpg}
...
\bibitem[Ahsan et~al.(2011)Ahsan, Williams, and Pizarro]{ahsan11}
Nasir Ahsan, Stefan~B. Williams, and Oscar Pizarro.
\newblock Robust broad-scale benthic habitat mapping when training data is
  scarce.
\newblock 2011.

\bibitem[Belanger et~al.(2012)Belanger, Jablonski, Roy, Berke, Krug, and
  Valentine]{belanger12}
...
\bibitem[Bender et~al.(2012)Bender, B., Williams, and Pizarro]{bender12}
Asher Bender, Stefan B., Williams, and Oscar Pizarro.
\newblock Classification with probabilistic targets.
\newblock 2012.

\bibitem[Caruana and Niculescu-Mizil(2006)]{caruana06}
...
\bibitem[Halpern et~al.(2008)Halpern, Walbridge, Selkoe, Kappel, Micheli,
  D'Agrosa, Bruno, Casey, Ebert, Fox, Fujita, Heinemann, Lenihan, Madin, Perry,
  Selig, Spalding, Steneck, and Watson]{halpern08}
...
\newblock \emph{Science}, 319:\penalty0 948--952, 2008.

\bibitem[Hannes~Nickisch(2008)]{nickisch08}
Carl Edward~Rasmussen Hannes~Nickisch.
\newblock Approximations for binary process classification.
\newblock \emph{Journal of Machine Learning Research}, 9:\penalty0 2035--2078,
  2008.

\bibitem[Hasan et~al.(2014)Hasan, Ierodiaconou, Laurenson, and
  Schimel]{hasan14}
...
\bibitem[Kostylev(2012)]{kostylev12}
Vladimir Kostylev.
\newblock Benthic habitat mapping from seabed acoustic surveys: do implicit
  assumptions hold?
\newblock 2012.

\bibitem[Lucieera et~al.(2013)Lucieera, Hilla, Barretta, and Nichol]{lucieer13}
...
\newblock Do marine substrates ‘look’ and ‘sound’ the same? supervised
  ...
  images.
\newblock \emph{Estuarine, Coastal and Shelf Science}, 117:\penalty0 94--106,
  2013.

\bibitem[Quinonero-Candela and Rasmussen(2005)]{candela05}
...
\bibitem[Rigby et~al.(2010)Rigby, Pizarro, and Williams]{rigby10}
Paul Rigby, Oscar Pizarro, and Stefan~B. Williams.
\newblock Toward adaptive benthic habitat mapping using gaussian process
  classification.
\newblock \emph{Journal of Field Robotics}, 27:\penalty0 741--758, 2010.

\bibitem[Seiler et~al.(2012)Seiler, Friedman, Steinberg, Barrett, Williams, and
  Holbrook]{seiler12}
...
\newblock \emph{Continental Shelf Research}, 45:\penalty0 87--97, 2012.

\bibitem[Steinberg et~al.(2011)Steinberg, Friedman, Pizarro, Williams, and
  S.B.]{steinberg11}
