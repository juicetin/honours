...
\begin{multicols}{2}
    ...
    \begin{enumerate}
        ...
        \item What is Gaussian Process Regression
        \item What is Gaussian Process Classification
    \end{enumerate}
